...
ROSTCP --deserialize in rospy--> std_msgs.msg.Duration --serialize (dump) in pyros_msgs--> dict
And reversely :
dict --deserialize (load) in pyros_msgs--> std_msgs.msg.Duration --serialize in rospy--> ROSTCP
