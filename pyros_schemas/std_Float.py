...
ROSTCP --deserialize in rospy--> std_msgs.msg.Float[32/64] --serialize (dump) in pyros_schemas--> dict
And reversely :
dict --deserialize (load) in pyros_schemas--> std_msgs.msg.Float[32/64] --serialize in rospy--> ROSTCP
